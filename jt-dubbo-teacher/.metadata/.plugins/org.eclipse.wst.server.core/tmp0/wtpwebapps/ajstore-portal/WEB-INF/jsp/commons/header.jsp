...
<header id="top">
	...
	<div class="rt">
		<ul class="lf" id="iul">
			...
			<b>|</b>
			<!--  <a href="http://sso.ajstore.com:90
			/user/checkLogin.html">checkLogin</a>-->
			</li>
		</ul>
	</div>
	<br />
	...
	<script type="text/javascript">
		$(function () {
			//跨域请求
			//请求的是本网站的controller,controller使用httpClient完成跨域请求
			$.ajax({
				type:"POST",
				url:"/user/checkLogin.html",
				xhrFields:{withCredentials:true},//加上后,发cookie
				dataType:"json",
				success:function(result){
